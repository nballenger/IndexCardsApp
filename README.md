...
4. **It's not a webapp.** - Your kitchen table isn't backed by a web service, and neither is this.
5. **It doesn't need AI.** - I can't imagine a reason for the application itself to have AI built into it. It just seems silly and/or intrusive. That said, if you want to have an AI tool drive it, be my guest.
6. **It's free.** - I don't have the inclination (or the patience) to make this a commercial product, so consider it a gift from me to you. I like making things, and it would make me pretty happy to know if you get some use out of this thing, or if you have thoughts about how to make it better. Also if you want to buy me a coffee you totally can, and I'd be happy about that too.
